...
contract EthLocker is Errors {
    ...
    // If locked is equal to 1, then functions with the ethUnlocked modifier revert
    // If locked is equal to 2, then only 1 function with the ethUnlocked modifier works in the multicall
