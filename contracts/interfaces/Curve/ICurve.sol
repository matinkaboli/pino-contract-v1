...
interface ICurve {
     ...
     * @param _pool Address of the pool
     */
    function removeLiquidity(uint256 _amount, uint256[2] memory _minAmounts, ICurvePool _pool) external payable;
     ...
     * @param _pool Address of the pool
     */
    function removeLiquidityOneCoinI(uint256 _amount, int128 _i, uint256 _minAmount, ICurvePool _pool)
        external
        payable;
